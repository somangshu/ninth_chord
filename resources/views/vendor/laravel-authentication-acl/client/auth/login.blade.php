...
<div class="row centered-form">
    <h3 class="text-center lead"><a id="logo" href="/">Baburao</a></h3>
    <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title bariol-thin">Board {!! Config::get('acl_base.app_name') !!}'s deck</h3>
            </div>
            ...
            <div class="panel-body">
                ...
                <input type="submit" value="Login" onclick="validateLogin();" class="btn btn-info btn-block">
                {!! Form::close() !!}
        <div class="row">
